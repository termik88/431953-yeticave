...
VALUES ('ignat.v@gmail.com', 'Игнат', '$2y$10$OqvsKHQwr0Wk6FMZDoHo1uHoXd4UdxJG/5UDtUiie00XaxMHrW8ka', 'avatar1.jpg', '');
INSERT INTO users (email, name, password, avatar, contact)
VALUES ('kitty_93@li.ru', 'Леночка', '$2y$10$bWtSjUhwgggtxrnJ7rxmIe63ABubHQs0AS0hgnOo41IEdMHkYoSVa', 'avatar2.jpg', '');
INSERT INTO users (email, name, password, avatar, contact)
VALUES ('warrior07@mail.ru', 'Руслан', '$2y$10$2OxpEH7narYpkOT1H5cApezuzh10tZEEQ2axgFOaKW.55LxIJBgWW', 'avatar3.jpg', '');

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_categori)
VALUES ('2014 Rossignol District Snowboard', 'Существует множество различных конструкций и технологий от раздвоенных хвостов,
        ...
        Lib Tech SK8 Banana.', 'img/lot-1.jpg', 10999, '2018-04-21', 2, 1, 1);

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_categori)
VALUES ('DC Ply Mens 2016/2017 Snowboard', 'Легкий маневренный сноуборд, готовый дать жару в любом парке, растопив снег
          ...
          равнодушным.', 'img/lot-2.jpg', 159999, '2018-03-21', 2, 1, 1);

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_winner, id_categori)
VALUES ('Крепления Union Contact Pro 2015 года размер L/XL', 'Комфортные и надежные крепления Freestyle созданы как для паркового катания,
        ...
        надежными стрепами позволит забыть о проблеме внезапной замены креплений.', 'img/lot-3.jpg', 8000, '2018-02-28', 2, 3, 1, 2);

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_categori)
VALUES ('Ботинки для сноуборда DC Mutiny Charocal', 'Burton Mint - одни из самых популярных ботинок в женской линейке Burton. Не зависимо от
        ...
        немаловажно для сноубордисток, следящих за своим стилем.', 'img/lot-4.jpg', 10999, '2018-03-08', 1, 2, 3);

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_winner, id_categori)
VALUES ('Куртка для сноуборда DC Mutiny Charocal', 'В этой классически скроенной куртке Вы забудете что такое озноб, ведь она наполнена лёгким
        и тёплым пухом и снабжена тёплой подкладкой из тафты. Плюс обязательная в таких случаях
        водоупорная дышащая мембрана.', 'img/lot-5.jpg', 7500, '2018-03-01', 1, 3, 2, 4);

INSERT INTO lots (name, description, picture, start_price, date_of_completion, step, id_author, id_categori)
VALUES ('Маска Oakley Canopy', 'Маска EG2 – это буквально качественный широкоформатный экран для Ваших глаз при поездке
        ...
        а силиконовые вставки помогут избежать соскальзывание. ', 'img/lot-6.jpg', 500, '2018-03-03', 1, 3, 6);

INSERT INTO bets (date, sum, id_user, id_lot)
...
INSERT INTO bets (date, sum, id_user, id_lot)
VALUES ('2018-03-07  00:00:00',700, 1, 4);
